...
|          | Rmmv软件1.5版本可能是下面的报错：                         |
|          |                                                           |
|          | ![](media/image2.png){width="4.808333333333334in"         |
...
|          |                                                           |
|          | （如果你是用1.5版本以下的                                 |
|          | rmmv，可能不能正常显示中文，建议升级rmmv软件或购买正版）  |
+----------+-----------------------------------------------------------+
...
| 题名称** |                                                           |
+==========+===========================================================+
| **问     | ![](media/image3.png){width="3.7441119860017498in"        |
| 题图示** | height="2.841666666666667in"}                             |
+----------+-----------------------------------------------------------+
| **问     | 出现黄色提示报错中的一种，有 Cannot read property xxxx of |
| 题描述** | undefined 的字样。                                        |
+----------+-----------------------------------------------------------+
| **原     | 该问题属于正常报错，插件找                                |
...
|          |                                                           |
|          | （mog插件                                                 |
|          | 都有这个问题；drill插件中做了兼容，所以目前不存在此问题） |
+----------+-----------------------------------------------------------+
| **解     | 删除旧存档即可。                                          |
| 决方案** |                                                           |
|          | 当然，这对于部署了游戏                                    |
...
| 题名称** |                                                           |
+==========+===========================================================+
| **问     | ![](media/image4.png){width="4.730336832895888in"         |
| 题图示** | height="1.9727766841644794in"}                            |
+----------+-----------------------------------------------------------+
...
| 题名称** |                                                           |
+==========+===========================================================+
| **问     | 按F8，可以看到下面这个情况。（之后窗口会瞬间关闭）        |
| 题图示** |                                                           |
|          | ![](media/image5.png){width="4.175in"                     |
|          | height="1.4360673665791777in"}                            |
+----------+-----------------------------------------------------------+
| **问     | 一                                                        |
| 题描述** | 般进入超大地图时，等的时间超过3秒后，有概率触发这种闪退。 |
+----------+-----------------------------------------------------------+
| **原     | 这种情况通常发生的可                                      |
...
| 题名称** |                                                           |
+==========+===========================================================+
| **问     | ![](media/image6.png){width="1.2251060804899387in"        |
| 题图示** | height="0.9084120734908137in"}                            |
+----------+-----------------------------------------------------------+
...
| 题图示** | File                                                      |
|          | s\\1355126171\\Image\\Group\\Image1\\(GQN81YKT\`A\`)2L2MO |
|          | R}G91.png](media/image7.png){width="1.7083333333333333in" |
...
+----------+-----------------------------------------------------------+
| **原     | 目前已知的一种情况                                        |
| 理解析** | 是，声音文件的名字含有符号"#"。该问题会造成rmmv部署失败。 |
+----------+-----------------------------------------------------------+
| **解     | 打包前，检查一下文件名，                                  |
| 决方案** |                                                           |
|          | 将所有含"#"号的文件改名即可。                             |
...
| 和**     |                                                           |
|          | ![](media/image8.png){width="2.933333333333333in"         |
| **问     | height="1.3053991688538                                   |
| 题描述** | 933in"}![](media/image9.png){width="1.6666666666666667in" |
|          | height="0.4511975065616798in"}                            |
|          |                                                           |
|          | 部署后，会发现audio和movies文件夹都没有。                 |
|          |                                                           |
|          | ![C                                                       |
|          | :\\Users\\Administrator\\AppData\\Roaming\\Tencent\\Users |
|          | \\1355126171\\QQ\\WinTemp\\RichOle\\6SXND_0)0LVT04\[6GUX7 |
|          | \~6M.png](media/image10.png){width="3.6666666666666665in" |
